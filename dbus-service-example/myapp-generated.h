...
G_DEFINE_AUTOPTR_CLEANUP_FUNC (MyAppNetCorpMyAppFrobberProxy, g_object_unref)
#endif
...
#if GLIB_CHECK_VERSION(2, 44, 0)
G_DEFINE_AUTOPTR_CLEANUP_FUNC (MyAppNetCorpMyAppFrobberSkeleton, g_object_unref)
#endif
